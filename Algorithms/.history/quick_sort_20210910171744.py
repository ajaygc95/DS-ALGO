...
I have some question around optimize 

I see on line 14 that you have instantiated the driver, 
lets just say you had 25 different pages how would you optimize


how would you iptimize this if you have multiple pages.
If you wanted to unit test this set of code, how would you do it. 
